...
make -j4 -C $COCOS2DX20_TRUNK/external/Box2D/proj.linux DEBUG=1
check_make_result

make -j4 -C $COCOS2DX20_TRUNK/external/chipmunk/proj.linux DEBUG=1
check_make_result

make -j4 -C $COCOS2DX20_TRUNK/cocos2dx/proj.linux DEBUG=1
check_make_result

make -j4 -C $COCOS2DX20_TRUNK/CocosDenshion/proj.linux DEBUG=1
check_make_result

make -j4 -C $COCOS2DX20_TRUNK/extensions/proj.linux DEBUG=1
check_make_result
